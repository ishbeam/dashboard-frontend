...
class OrderDetails extends Component {
  ...
  toggleSelectDriver = () => {
    this.setState({ showSelectDriver: !this.state.showSelectDriver })
  }

  onSelectDriver = (d) => {
    this.setState({ showSelectDriver: false })

    setDriver(this.props.orderId, d._id).then(({ data }) => {
      console.log(data)
      this.setState({ order: data })
  ...
  render() {
    const { bid, hasCarrier, driverSelected, showSelectDriver, order } = this.state;
    const { driver } = order;
      ...
      <div>
        ...
        <div className="container">
          <div className="full-width clearfix">
            <div className="card grid1of3">
              <div className="inner_3">
                <h2 className="mt-0 pt-0 fontSemiBold">Order Details</h2>


                <div className="compact">
                  <label className="mb-4">Product / Quantity</label>
                  {(order.products.map((p) => (
                    <div>
                      <p>{p.quantity} gallons of {p.fuel_type}</p>
                    </div>
                  )))}
            ...
            <div id="table" className="card grid2of3">
              ...
              <div className="full-width">
                ...
                <div className="grid2of3">
                  {order._id && order.pickup && order.pickup.location
                    ? <DirectionsMap
          ...
          <div className="full-width clearfix ">
            <div id="table" className="card grid1of3 mt-2">
              <div className="full-width">
                <div className="inner_3">
                  ...
                  <div className="full-width ">
                    ...
                    <div className="mt-2 mb-2 pull-right">
                      {/* <Button onClick={() => alert('This will take you to a payment screen')}>Pay Now</Button> */}
